...
class MXSMS_Model
{
	...
	* Table name
	*/
	protected $table = MXSMS_TABLE_SLUG;
	...
	*/
	public function mxsms_get_row( $table = NULL, $wher_name='', $wher_value='' )
	{
	...
	*/
	public function mxsms_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
